package com.tistory.zxcv5500.app_mvp.model;
...
/**
 * Created by zxcv5500 on 2018-01-04.
...
public interface GitHubService {
	 ...
	 * @param query Gihub API로 검색할 내용
	 * @return API 액세스 결과 취득 후의 콜백으로서 SearchReponse를 가져올 수 있는 RxJava의 Observable로 반환한다.
	 */
	...
	public static class Repositories {
		...
		public Repositories(List<RepositoryItem> items) { this.items = items; }
	}
